...
#### USB Redirect
* 使用Windows客户端上的USB设备
> 如果需要把 Windows 客户端系统上的 USB 设备重定向到虚拟机上，则需要在 Windows 客户端上安装 usbdk [64位](https://www.spice-space.org/download/windows/usbdk/UsbDk_1.0.22_x64.msi)  [32位](https://www.spice-space.org/download/windows/usbdk/UsbDk_1.0.22_x86.msi)。您需要确定所使用的 usbdk 版本与客户端系统的系统相匹配。例如，64 位版的 usbdk 必须安装在 64 位的 Windows 系统上。
>
